			...
			<div id="postbox-container-1" class="postbox-container-1 fp5-sidebar">
				<div id="side-sortables" class="ui-sortable metabox-holder">
					...
					<h3 class="hndle"><span><?php _e( 'About Flowplayer HTML5', 'flowplayer5' ); ?></span></h3>
						<div class="inside">
							<p><a target="_blank" title="Flowplayer HTML5 for WordPress FAQ" href="http://wordpress.org/plugins/flowplayer5/faq/"><?php _e( 'FAQ', 'flowplayer5' ); ?></a></p>
							<p><a target="_blank" title="Flowplayer HTML5 for WordPress Support Forum" href="http://wordpress.org/support/plugin/flowplayer5/"><?php _e( 'Support Forum', 'flowplayer5' ); ?></a></p>
							<p><a target="_blank" title="Review Flowplayer HTML5 for WordPress" href="http://wordpress.org/support/view/plugin-reviews/flowplayer5/"><?php _e( 'Rate us on WordPress.org', 'flowplayer5' ); ?></a></p>
							<p><a target="_blank" title="Flowplayer HTML5 for WordPress Changelog" href="http://wordpress.org/plugins/flowplayer5/changelog/"><?php _e( 'Changelog', 'flowplayer5' ); ?></a></p>
